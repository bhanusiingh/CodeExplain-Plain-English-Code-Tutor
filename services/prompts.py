...
def build_explanation_prompt(code: str, language: str) -> str:
    ...
    output_format_block: str = (
        ...
        "{h_line_by_line}\n"
        "Explain every line (or every logical block, for long code) individually. "
        "Use the format:\n"
        "  Line <number> - <plain-English explanation>\n"
        "For a block of lines that work together (e.g. a for-loop), group them "
        "under:  Lines <start>-<end> - <explanation>.\n\n"
        "{h_time_complexity}\n"
